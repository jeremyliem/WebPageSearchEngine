...
public class TestDoubleLinkedList extends BaseTest {
    ...
    public void testDeleteMiddle() {
        ...
        list.delete(1);
        this.assertListMatches(new String[] {"a", "c", "d", "e", "f"}, list);
        assertEquals(5, list.size());
        list.delete(3);
        this.assertListMatches(new String[] {"a", "c", "d", "f"}, list);
        assertEquals(4, list.size());
        list.delete(2);
        this.assertListMatches(new String[] {"a", "c", "f"}, list);
    ...
    //Test edge case: Deleting from the front
    @Test(timeout = SECOND)
    ...
    //Test edge case: deleting from the back
    @Test(timeout = SECOND)
    ...
    //Test Exception case(Out of Bounds index)
    @Test(timeout = SECOND)
    ...
    //Test Deleting on empty list (empty case)
    @Test(timeout = SECOND)
    public void testDeleteOnEmptyListException() {
        IList<String> list = this.makeBasicList();
        list.remove();
        list.remove();
        list.remove();
    ...
    @Test(timeout = SECOND)
    public void testDeleteOnSingleElementList() {
        IList<String> list = this.makeBasicList();
        list.remove();
        list.remove();
        list.delete(0);
